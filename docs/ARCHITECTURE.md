...
The lifecycle implemented through Phase 8 is: requester submission → FMO screening → approval/disapproval → skilled personnel assignment → staff assessment/investigation → ready for work or management exception review. Work execution, individual updates, completion and verification remain future phases. Assignment is not authorization to begin work. See [assignment and assessment](ASSIGNMENT_ASSESSMENT.md).
